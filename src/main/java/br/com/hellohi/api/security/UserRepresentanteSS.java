 ...
 * @author junior
 */
public class UserRepresentanteSS implements UserDetails {
    ...
    public UserRepresentanteSS() {
    }

    public UserRepresentanteSS(Long id, String nome, String login, String senha, Empresa empresa, Set<Perfil> perfis) {
        this.id = id;
        this.nome = nome;
        this.login = login;
        this.senha = senha;
