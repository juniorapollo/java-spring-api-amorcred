    ...
    (/** @lends <global> */function ($) {
        ...
        DataTable.defaults = {
            ...
            "oLanguage": {
                 ...
                 *
                 *  @type string
                 *  @default Exibindo _START_ to _END_ of _TOTAL_ entries
                 *
                 *  @dtopt Language
                 ...
                 *    } );
                 */
                "sInfo": "Exibindo _START_ to _END_ of _TOTAL_ entries",
                /**
...
$.fn.dataTable.ext.search.push(
        function (settings, data, dataIndex) {
            var min = document.getElementById('minDia').value * 1;
            var max = document.getElementById('maxDia').value * 1;
            var version = data[0] == "-" ? 0 : data[0] * 1;
...
$.fn.dataTable.ext.search.push(
        function (settings, data, dataIndex) {
            var min = document.getElementById('minMes').value * 1;
            var max = document.getElementById('maxMes').value * 1;
            var version = data[0] == "-" ? 0 : data[0] * 1;
...
$.fn.dataTable.ext.search.push(
        function (settings, data, dataIndex) {
            var min = document.getElementById('minAno').value * 1;
            var max = document.getElementById('maxAno').value * 1;
            var version = data[0] == "-" ? 0 : data[0] * 1;
