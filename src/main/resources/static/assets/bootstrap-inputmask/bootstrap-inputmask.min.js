    ...
    r.prototype = {
        ...
        caret: function (e, t) {
            if (this.$element.length === 0)
                return;
            if (typeof e == "number")
                return t = typeof t == "number" ? t : e, this.$element.each(function () {
            ...
            if (this.$element[0].setSelectionRange)
                e = this.$element[0].selectionStart, t = this.$element[0].selectionEnd;
        ...
        shiftL: function (e, t) {
            ...
            for (var r = e, i = this.seekNext(t); r < n; r++)
                if (this.tests[r]) {
                    if (!(i < n && this.tests[r].test(this.buffer[i])))
                        break;
        ...
        keydownEvent: function (e) {
            ...
            if (n == 27)
                return this.$element.val(this.focusText), this.caret(0, this.checkVal()), !1
        },
        keypressEvent: function (e) {
            var t = this.mask.length,
                    n = e.which,
                    r = this.caret();
            if (e.ctrlKey || e.altKey || e.metaKey || n < 32)
                return !0;
            if (n) {
...
if (e || r + 1 >= this.partialPosition) this.writeBuffer(), e || this.$element.val(this.$element.val().substring(0, r + 1));
