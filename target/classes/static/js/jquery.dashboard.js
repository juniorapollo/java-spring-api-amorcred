    ...
    Dashboard.prototype.createPieGraph = function(selector, labels, datas, colors) {
        ...
        Dashboard.prototype.init = function() {
          ...
          this.createPlotGraph("#website-stats", uploads, downloads, plabels, pcolors, borderColor, bgColor);
            ...
            //Pie graph data
            var pielabels = ["Representante 1","Representante 2","Representante 3","Representante 3"];
            var datas = [20,30, 20];
            var colors = ["rgba(30, 136, 229, 0.7)", "rgba(41, 182, 246, 0.7)", "rgba(126, 87, 194, 0.7),rgba(30, 136, 229, 0.7)"];
